...
public class ExerciseClassAdapter extends RecyclerView.Adapter<ExerciseClassAdapter.ViewHolder> {

    private final ArrayList<ExerciseDietModel> arrayList;
    private final Context context;

    public ExerciseClassAdapter(ArrayList<ExerciseDietModel> arrayList, Context context) {
    ...
    @NonNull
    @Override
    public ExerciseClassAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View listItem= layoutInflater.inflate(R.layout.exercises_card, parent, false);
        return new ViewHolder(listItem);
    }

    @Override
    public void onBindViewHolder(@NonNull ExerciseClassAdapter.ViewHolder holder, int position) {
